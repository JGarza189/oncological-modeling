...
**Note:** MATLAB code is not rendered in GitHub and may not be easily visualized. For quick reference, you can either open the `oncology.model.txt` file directly in GitHub or view it in your preferred text or source code editor for better readability.
